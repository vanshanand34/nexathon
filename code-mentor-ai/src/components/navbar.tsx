...
export default function NavBar() {
  ...
  return (
    <div
      className={`${geistRegular.className} z-10 bg-white dark:bg-[#0e0e0e] dark:shadow-gray-950 text-black dark:text-white w-[100vw] flex justify-between shadow fixed shadow-gray-300 gap-2 p-1 pt-2`}
    >
